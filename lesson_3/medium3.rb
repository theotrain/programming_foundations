...
def tricky_method(a_string_param, an_array_param)
  puts "------- second ----------"
  puts "#{a_string_param} OBJECT ID: #{a_string_param.object_id}"
  puts "#{an_array_param} OBJECT ID: #{an_array_param.object_id}"
...
puts "My string looks like this now: #{my_string}" # expect 'rutabaga'
puts "My array looks like this now: #{my_array}" # expect ["pumpkins"]
